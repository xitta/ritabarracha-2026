...
const caseStudies = [
  ...
  },
  {
    ...
    summary:
      "This engagement represents one of the most significant digital consolidations in Swiss retail — and one that unfolded over several years, across multiple organisational layers and brand identities.\n\nLeShop.ch had been Switzerland's leading online supermarket since 1997, and although it had been part of the Migros Group for years, it operated as a largely independent entity. The first step was the rebrand to Migros Online: a strategic move to bring the platform into closer alignment with the parent brand, signal continuity to loyal customers, and lay the groundwork for a deeper integration.\n\nThe more complex challenge came next. Envisioning how Migros Online would eventually dissolve into migros.ch meant rethinking the digital product from the ground up — not just as an e-commerce platform, but as the unified digital presence of Switzerland's largest retailer. That required reconciling two very different shopping contexts: the convenience-led, delivery-focused experience of online grocery, and the broader, discovery-oriented world of physical Migros stores with their full non-food assortment, services, and regional presence.\n\nMy advisory role focused on helping stakeholders see the full picture — where the brand needed to go, how the user experience could scale to hold both worlds without losing coherence, and what decisions needed to be made early to avoid costly friction later. Strategic design at this level is less about individual screens and more about creating the conditions for good decisions to be made consistently, across teams and over time.\n\nThe result is migros.ch as it stands today: a single digital home for one of Switzerland's most trusted brands, serving millions of customers across online and offline touchpoints — and a platform built to evolve with the retailer it represents.",
